...
Version  : 4.23
Release  : 34
URL      : https://github.com/i3/i3/archive/4.23/i3-4.23.tar.gz
Source0  : https://github.com/i3/i3/archive/4.23/i3-4.23.tar.gz
...
%prep
%setup -q -n i3-4.23
cd %{_builddir}/i3-4.23
%patch -P 1 -p1
%patch -P 2 -p1
pushd ..
cp -a i3-4.23 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701968832
...
meson --libdir=lib64 --prefix=/usr --buildtype=plain --sysconfdir=/usr/share/defaults/i3  builddir
ninja -v -C builddir
