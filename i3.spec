...
Version  : 4.21.1
Release  : 28
URL      : https://github.com/i3/i3/archive/4.21.1/i3-4.21.1.tar.gz
Source0  : https://github.com/i3/i3/archive/4.21.1/i3-4.21.1.tar.gz
...
%prep
%setup -q -n i3-4.21.1
cd %{_builddir}/i3-4.21.1
%patch1 -p1
%patch2 -p1
pushd ..
cp -a i3-4.21.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666834455
