...
Version  : 4.20
Release  : 17
URL      : https://github.com/i3/i3/archive/4.20/i3-4.20.tar.gz
Source0  : https://github.com/i3/i3/archive/4.20/i3-4.20.tar.gz
...
%prep
%setup -q -n i3-4.20
cd %{_builddir}/i3-4.20
%patch1 -p1
%patch2 -p1
pushd ..
cp -a i3-4.20 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1635191938
...
cp %{_builddir}/i3-4.20/LICENSE %{buildroot}/usr/share/package-licenses/i3/3884a0d877db89ec2bad44adcb129ee4878458e2
cp %{_builddir}/i3-4.20/debian/copyright %{buildroot}/usr/share/package-licenses/i3/8289e87adc66e6622c0801c873dd5793ca4bda0a
cp %{_builddir}/i3-4.20/i3bar/LICENSE %{buildroot}/usr/share/package-licenses/i3/af3376079066b36e94bd0b123e61c632cf5e4fe8
