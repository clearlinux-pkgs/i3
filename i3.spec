...
Version  : 4.21
Release  : 27
URL      : https://github.com/i3/i3/archive/4.21/i3-4.21.tar.gz
Source0  : https://github.com/i3/i3/archive/4.21/i3-4.21.tar.gz
...
%prep
%setup -q -n i3-4.21
cd %{_builddir}/i3-4.21
%patch1 -p1
%patch2 -p1
pushd ..
cp -a i3-4.21 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663789251
