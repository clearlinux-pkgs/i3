...
Source0  : https://github.com/i3/i3/archive/4.18.1/i3-4.18.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587570036
...
cp %{_builddir}/i3-4.18.1/LICENSE %{buildroot}/usr/share/package-licenses/i3/1d97c45411045f7c4342c849a3c4621ac8ae8bf9
cp %{_builddir}/i3-4.18.1/debian/copyright %{buildroot}/usr/share/package-licenses/i3/8289e87adc66e6622c0801c873dd5793ca4bda0a
cp %{_builddir}/i3-4.18.1/i3bar/LICENSE %{buildroot}/usr/share/package-licenses/i3/af3376079066b36e94bd0b123e61c632cf5e4fe8
%make_install
